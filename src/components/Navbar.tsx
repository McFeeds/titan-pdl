  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0d0d1f]/90 backdrop-blur-md border-b border-white/10">
      <div className="max-w-7xl mx-auto px-6 flex items-center h-16 gap-1">
        ...
        <button className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-700 text-white text-sm font-semibold px-4 py-2 rounded-lg transition-colors shrink-0">
          <svg
            viewBox="0 0 24 24"
